...
import { getOperatorRevenue } from "@/services/operatorService";
...
const RevenuePage = () => {
  ...
  useEffect(() => {
    const loadRevenue = async () => {
      try {
        const data = await getOperatorRevenue();
        ...
        setMetrics({
          ...
          paidBookings,
          pendingPayments,
          averageBookingValue: data.length > 0 ? totalRevenue / data.length : 0,
        });
